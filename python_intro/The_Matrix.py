...
# constant variable; all-uppercase name
# In Python, nothing prevents you from changing a constant’s value,
# but the uppercase name can remind the programmer not to do so.
